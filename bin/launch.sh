...
export AMQ_KEYSTORE_TRUSTSTORE_DIR=$AMQ_KEYSTORE_TRUSTSTORE_DIR
export AMQ_KEYSTORE=$AMQ_KEYSTORE
export AMQ_KEYSTORE_PASSWORD=$AMQ_KEYSTORE_PASSWORD
export AMQ_TRUSTSTORE=$AMQ_TRUSTSTORE
export AMQ_TRUSTSTORE_PASSWORD=$AMQ_TRUSTSTORE_PASSWORD
export AMQ_VIEW_GROUPS=$AMQ_VIEW_GROUPS
export AMQ_EDIT_GROUPS=$AMQ_EDIT_GROUPS
export AMQ_ADMIN_GROUPS=$AMQ_ADMIN_GROUPS
export AMQ_HAWTIO_GROUPS=$AMQ_HAWTIO_GROUPS
